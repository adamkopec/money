...
class ZeroMoneyTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @covers \SebastianBergmann\Money\ZeroMoney::__construct
     * @uses    \SebastianBergmann\Money\NullCurrency
     */
    public function testCanBeConstructed()
    {
        $m = new ZeroMoney();

        $this->assertInstanceOf(ZeroMoney::class, $m);

        return $m;
    }

    /**
     * @covers  \SebastianBergmann\Money\ZeroMoney::getAmount
     * @depends testCanBeConstructed
     * @param   ZeroMoney $m
     */
    public function testAmountCanBeRetrieved(ZeroMoney $m)
    {
        $this->assertEquals(0, $m->getAmount());
    }

    /**
     * @covers \SebastianBergmann\Money\ZeroMoney::getConvertedAmount
     * @uses   \SebastianBergmann\Money\NullCurrency
     * @depends testCanBeConstructed
     * @param   ZeroMoney $m
     */
    public function testConvertedAmountCanBeRetrieved(ZeroMoney $m)
    {
        $this->assertSame(0.0, $m->getConvertedAmount());
    }

    /**
     * @covers  \SebastianBergmann\Money\ZeroMoney::getCurrency
     * @uses    \SebastianBergmann\Money\NullCurrency
     * @depends testCanBeConstructed
     * @param   Money $m
     */
    ...
    {
        $this->assertEquals(new NullCurrency(), $m->getCurrency());
    }

    /**
     * @covers \SebastianBergmann\Money\ZeroMoney::add
     * @uses   \SebastianBergmann\Money\ZeroMoney::__construct
     ...
     * @uses   \SebastianBergmann\Money\NullCurrency
     */
    public function testAnotherMoneyObjectCanBeAddedNoMatterTheCurrency()
    {
        $a = new ZeroMoney();
        ...
        $this->assertEquals(2, $c->getAmount());
    }

    public function testCanBeAddedToAnotherMoneyObjectNoMatterTheCurrency()
    {
        $a = new ZeroMoney();
        $b = new Money(2, new Currency('EUR'));
        $c = $b->add($a);
